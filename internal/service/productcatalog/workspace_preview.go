...
func WorkspacePreviewCatalog() (WorkspaceModelList, error) {
	...
	return WorkspaceCatalog(WorkspaceConfig{ImageReferenceUploads: true, ImageModels: images, TextModels: textgeneration.Models(textIDs, prices), VideoRoutes: catalog.VideoRoutes(), Pricing: prices}), nil
}
