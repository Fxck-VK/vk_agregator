...
func TestFromConfigSeedream45VisibleWhenReadyEnabledAndPriced(t *testing.T) {
	...
	if image.DefaultQuality != modelcatalog.ImageQuality2K || image.EstimateCredits != 30 || !image.SupportsReferenceImage || image.MaxReferenceImages != 10 {
...
func TestFromConfigNanoBananaProUsesAPIMartReadiness(t *testing.T) {
	...
	if image.DefaultQuality != modelcatalog.ImageQuality1K || image.EstimateCredits != 50 || !image.SupportsReferenceImage || image.MaxReferenceImages != 14 {
