...
const legacyKeys = ["catalog.imageDescription", "catalog.textDescription", "catalog.qualityResolution", "catalog.qualityMode", "catalog.quality", "catalog.pendingDescription", "catalog.pendingImageDescription", "catalog.pendingSpeechDescription", "catalog.musicDescription"] as const;
