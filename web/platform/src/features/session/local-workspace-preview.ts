...
import modelCatalogPreview from "./model-catalog.preview.json";
import { parseModelCatalog, projectChatModelCatalog, projectImageModelCatalog, projectVideoModelCatalog } from "../models/model-catalog-contract";

// Generated by go run ./scripts/models/preview from the backend catalog.
export const localWorkspacePreviewModels = parseModelCatalog(modelCatalogPreview);
export const localWorkspacePreviewVideoModels = projectVideoModelCatalog(localWorkspacePreviewModels);
...
export const localWorkspacePreviewChatModels = projectChatModelCatalog(localWorkspacePreviewModels);
...
export const localWorkspacePreviewImageModels = projectImageModelCatalog(localWorkspacePreviewModels);
...
// Read-only UI samples. Preview must never create a payment or grant a balance.
export const localWorkspacePreviewPaymentProducts = {
  checkout_available: false,
  items: [
    { code: "preview-20000", credits: 20000, amount: 920000, currency: "RUB" },
    { code: "preview-10000", credits: 10000, amount: 470000, currency: "RUB" },
    { code: "preview-3000", credits: 3000, amount: 150000, currency: "RUB" },
    { code: "preview-1500", credits: 1500, amount: 75000, currency: "RUB" },
    { code: "preview-800", credits: 800, amount: 40000, currency: "RUB" },
  ],
};
