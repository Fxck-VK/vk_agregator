...
Assert-Contains $dockerImages '(index .SBOM "linux/amd64").SPDX' 'Docker Images platform SBOM assertion'
Assert-Contains $dockerImages '(index .Provenance "linux/amd64").SLSA' 'Docker Images platform provenance assertion'
