...
**Статус: реализовано локально 08.09.2026; включение в DEV/PROD и платная проверка не выполнялись.**
...
- [ ] Отдельно разрешённая пробная генерация с проверкой результата и фактического списания.
- [ ] Включение флага и тарифа в выбранном окружении.
...
Runtime/env, активные тарифы БД, commit, push и deploy не выполнялись. Frontend-код не менялся; браузерная проверка интерфейса не выполнялась.
