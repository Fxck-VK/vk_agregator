...
- [x] VK bot: меню всех шести моделей укладывается в лимит клавиатуры; выбор Grok создаёт один Job с резервом 10 кредитов и `resolution=quality`. Добавлен тест повторного входящего события. Живая генерация в ВК остаётся непроверенной.
