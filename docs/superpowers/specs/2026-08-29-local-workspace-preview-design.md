...
- Add unit tests proving preview activation in development and rejection in production.
...
- Reload `http://localhost:7158/app` and verify that the workspace shell, landing content, placeholder account, balance, and conversations render instead of the unavailable fallback.
